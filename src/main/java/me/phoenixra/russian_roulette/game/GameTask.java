    ...
    public void run() {
            switch (getState()) {
                ...
                case 4:
                    ...
                    else if (timer.timeLeft() == 4) game.broadcastMessage(LangClass.messages_teleport.replace("%timer%","4"));
                    else if (timer.timeLeft() == 3) game.broadcastMessage(LangClass.messages_teleport.replace("%timer%","3"));
                    else if (timer.timeLeft() == 2) game.broadcastMessage(LangClass.messages_teleport.replace("%timer%","2"));
                    else if (timer.timeLeft() == 1) game.broadcastMessage(LangClass.messages_teleport.replace("%timer%","1"));
                    break;
