...
public class LangClass extends PhoenixFileClass {
    ...
    @ConfigHeader(value= {""})
    @ConfigKey(path="bid_started_suicide", space="  ")
    ...
    @ConfigHeader(value= {""})
    @ConfigKey(path="bid_started_killOther", space="  ")
    ...
    @ConfigHeader(value= {""})
    @ConfigKey(path="bid_finished", space="  ")
    ...
    @ConfigHeader(value= {""})
    @ConfigKey(path="player_suicide", space="  ")
    ...
    @ConfigHeader(value= {""})
    @ConfigKey(path="player_damaged_other", space="  ")
    ...
    @ConfigHeader(value = {""})
    @ConfigKey(path="BecameSpectator", space= "  ")
    ...
    @ConfigHeader(value = {""})
    @ConfigKey(path="chooseVictim", space= "    ")
    ...
    @ConfigHeader(value = {""})
    @ConfigKey(path="GameSelectorMainPage", space= "    ")
    public static String gui_GameSelectorMainPage="Play the RussianRoulette";

    @ConfigHeader(value = {""})
    @ConfigKey(path="GameSelectorArenasPage", space= "    ")
    ...
    @ConfigHeader(value = {""})
    @ConfigKey(path="ArenaItem_Lore", space= "      ")
    ...
    @ConfigHeader(value = {""})
    @ConfigKey(path="closeItem_name", space= "      ")
    public static String gui_closeItem_name="&cClose";

    @ConfigHeader(value = {""})
    @ConfigKey(path="playItem_name", space= "      ")
    public static String gui_playItem_name="&aRandom game";

    @ConfigHeader(value = {""})
    @ConfigKey(path="playItem_lore", space= "      ")
    ...
    @ConfigHeader(value = {""})
    @ConfigKey(path="chooseArenaItem_name", space= "      ")
    public static String gui_chooseArenaItem_name="&aChoose specific arena";

    @ConfigHeader(value = {""})
    @ConfigKey(path="chooseArenaItem_lore", space= "      ")
    ...
    @ConfigHeader(value = {""})
    @ConfigKey(path="WaitingForShooter", space= "  ")
    ...
    @ConfigKey(path="killed_random", space="  ")
    ...
    @ConfigKey(path="injured_random", space="  ")
    ...
    @ConfigKey(path="misfire_random", space="  ")
    ...
    public Object getReference(int number) {
        Object[] ob = {section_general, general_unknown_cmd, general_no_permission,
                ...
                messages_misfire,messages_ShootWithoutBullets,
                messages_bid_started_suicide,messages_bid_started_killOther, messages_bidFinished,
                messages_player_suicide,messages_player_killed_other,
                messages_player_damaged_other,messages_finish,messages_teleport,
                section_titles,titles_BecameSpectator,titles_yourTurn,
                titles_secondRoundStart_title,titles_secondRoundStart_subtitle,
                titles_finalRoundStart_title,titles_finalRoundStart_subtitle,
                gui_section,gui_game_section,gui_game_chooseVictim,
                gui_selector_section,
                gui_GameSelectorMainPage,gui_GameSelectorArenasPage,
                gui_items_section,gui_ArenaItem_Lore,gui_closeItem_name,
                gui_playItem_name,gui_playItem_lore,
                gui_chooseArenaItem_name,gui_chooseArenaItem_lore,
                hologram_section,hologram_PendingForPlayers,hologram_RoundDelay,
                hologram_WaitingForShooter,hologram_BetTime,
                hologram_killed_random, hologram_injured_random, hologram_misfire_random,
                items_section,item_bidYes,item_bidNo,
                item_addBullet,item_removeBullet,item_shoot,item_shoot_victim,
                other_section,other_chatFormat_spectator,other_chatFormat_player,
                other_round_Disabled,
                other_round_PendingForPlayers,
                other_round_name_1,other_round_name_2,other_round_name_final,
                other_round_starting,
                other_round_active,other_round_finishing};
        return ob[number];
    }
}
